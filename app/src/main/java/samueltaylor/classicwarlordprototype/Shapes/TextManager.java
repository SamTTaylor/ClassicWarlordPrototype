...
public class TextManager {
    ...
    public void Draw(float[] m)
    {
        ...
        GLES20.glUseProgram(shaderCodes.progText);
        ...
        int mPositionHandle = GLES20.glGetAttribLocation(shaderCodes.progText, "vPosition");
        ...
        int mTexCoordLoc = GLES20.glGetAttribLocation(shaderCodes.progText, "a_texCoord" );
        ...
        int mColorHandle = GLES20.glGetAttribLocation(shaderCodes.progText, "a_Color");
        ...
        int mtrxhandle = GLES20.glGetUniformLocation(shaderCodes.progText, "uMVPMatrix");

        // Apply the projection and view transformation
        GLES20.glUniformMatrix4fv(mtrxhandle, 1, false, m, 0);

        int mSamplerLoc = GLES20.glGetUniformLocation (shaderCodes.progText, "s_texture" );
