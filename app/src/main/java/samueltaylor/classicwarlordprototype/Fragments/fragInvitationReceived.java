...
public class fragInvitationReceived extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        btnDismiss = (Button) getActivity().findViewById(R.id.btnDismiss);
        ...
        btnInvite = (Button) getActivity().findViewById(R.id.btnSeeInvites);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View fragInviteView = inflater.inflate(R.layout.fragment_invitation_received, container, false);
        return fragInviteView;
    }
